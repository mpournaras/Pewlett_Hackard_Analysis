...
-- Query anyone born between 1952 and 1955 will begin to retire
...
-- Retirement eligibility into a new table "retirement_info"
SELECT first_name, last_name
...
-- Employee count by department number *AS A NEW TABLE*
SELECT COUNT(ce.emp_no), de.dept_no
...
-- Create new table for retiring employees modified!
SELECT emp_no,
    first_name,
	last_name,
    gender
